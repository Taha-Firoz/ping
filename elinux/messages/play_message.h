...
#ifndef PACKAGES_PING_PING_ELINUX_MESSAGES_PLAY_MESSAGE_H_
#define PACKAGES_PING_PING_ELINUX_MESSAGES_PLAY_MESSAGE_H_
...
public:
    ...
    // Prevent copying.
    PlayMessage(PlayMessage const &) = default;
    PlayMessage &operator=(PlayMessage const &) = default;
    ...
    flutter::EncodableValue ToMap()
    {
        ...
        flutter::EncodableMap map = {
            ...
            {flutter::EncodableValue("loop"), flutter::EncodableValue(loop_)},
            {flutter::EncodableValue("packageName"), flutter::EncodableValue(package_name_)}
        };
        return flutter::EncodableValue(map);
    }

    static PlayMessage FromMap(const flutter::EncodableValue &value)
    {
        PlayMessage message;
        if (std::holds_alternative<flutter::EncodableMap>(value))
        {
            ...
            flutter::EncodableValue &loop =
                map[flutter::EncodableValue("loop")];
            if (std::holds_alternative<bool>(loop))
            {
                message.SetLoop(std::get<bool>(loop));
            }
        }
